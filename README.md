...
| No | Tampilan | Gambar |
|----|-----------|--------|
| 1 | Halaman Login | ![Login](penjualanPHP (1).png) |
| 2 | Halaman Dashboard | ![Dashboard](penjualanPHP (2).png) |
| 3 | Halaman Transaksi | ![Transaksi](penjualanPHP (3).png) |
| 4 | Halaman Data Transaksi | ![Data Transaksi](penjualanPHP (4).png) |
